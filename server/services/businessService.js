...
async function getCurrentBusinessFlags() {
  ...
  return {
    semeNo: rows[0].Semeno,
    curricularOpen: Boolean(rows[0].CurricularOpen),
    courseOpen: Boolean(rows[0].CourseOpen),
    enrollOpen: Boolean(rows[0].EnrollOpen),
  };
}

module.exports = { getCurrentBusinessFlags };